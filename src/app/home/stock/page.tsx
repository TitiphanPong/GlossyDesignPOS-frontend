    ...
    <AdminPageContainer>
      <Stack spacing={2.5}>
        <AdminHeroHeader
          ...
          primaryAction={privileged ? <Button variant="contained" startIcon={<AddRoundedIcon />} onClick={() => setCreateOpen(true)} sx={heroPrimaryButtonSx}>เพิ่มวัสดุ</Button> : undefined}
        />
