...
import {
  ...
  CardActions, List, ListItemButton, ListItemIcon, ListItemText, Chip, Divider, Grow
} from '@mui/material';
...
export default function LandingPage() {
  return (
      ...
      {/* Floating Orbs */}
      <Box aria-hidden sx={{ position: 'absolute', top: 80, left: -40, width: 220, height: 220, borderRadius: '50%',
        bgcolor: (t) => alpha(t.palette.primary.main, 0.12), filter: 'blur(20px)', animation: `${float} 8s ease-in-out infinite` }} />
      <Box aria-hidden sx={{ position: 'absolute', bottom: 80, right: -60, width: 260, height: 260, borderRadius: '50%',
        bgcolor: (t) => alpha(t.palette.secondary ? t.palette.secondary.main : t.palette.primary.main, 0.12), filter: 'blur(24px)', animation: `${float} 10s ease-in-out infinite` }} />
            ...
            <Reveal>
              <Card sx={{
                ...
                <CardContent>
                  ...
                  <Divider sx={{ mb: 1 }} />
                  <List>
                    <ListItemButton component={Link} href="/pos" sx={{
                      borderRadius: 2,
                      '&:hover': { bgcolor: (t)=>alpha(t.palette.primary.light,0.08) },
                      opacity: 0, animation: `${fadeUp} .45s ease forwards`, animationDelay: '0ms',
                    }}>
                      <ListItemIcon><PointOfSaleIcon /></ListItemIcon>
                      <ListItemText primary="ขายหน้าร้าน (POS)" secondary="คิดราคา/ส่วนลด ภาษี ชำระเงิน" />
                      <ArrowForwardIcon fontSize="small" />
                    </ListItemButton>

                    <ListItemButton component={Link} href="/jobs" sx={{
                      borderRadius: 2,
                      '&:hover': { bgcolor: (t)=>alpha(t.palette.primary.light,0.08) },
                      opacity: 0, animation: `${fadeUp} .45s ease forwards`, animationDelay: '90ms',
                    }}>
                      <ListItemIcon><PrintIcon /></ListItemIcon>
                      <ListItemText primary="คิวงานพิมพ์" secondary="ตรวจไฟล์/กำลังพิมพ์/เสร็จสิ้น" />
                      <ArrowForwardIcon fontSize="small" />
                    </ListItemButton>

                    <ListItemButton component={Link} href="/reports" sx={{
                      borderRadius: 2,
                      '&:hover': { bgcolor: (t)=>alpha(t.palette.primary.light,0.08) },
                      opacity: 0, animation: `${fadeUp} .45s ease forwards`, animationDelay: '180ms',
                    }}>
                ...
                <CardActions sx={{ px: 4, pb: 4 }} >
                  <Button component={Link} href="/home" variant="contained"  startIcon={<PointOfSaleIcon />}>เริ่มขายเลย</Button>
                  <Button component={Link} href="/settings" color="inherit" startIcon={<HelpOutlineIcon />}>ตั้งค่าร้าน</Button>
                </CardActions>
              </Card>
            </Reveal>
          </Box>
              ...
              <Card sx={{
                ...
                <CardContent>
                  <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }} marginTop={1} marginLeft={2}>
                    ...
                    <Typography variant="h5" sx={{ fontWeight: 700 }}>สำหรับลูกค้า</Typography>
                  </Stack>
                  <Typography color="text.secondary" sx={{ mb: 2 }} marginTop={1} marginLeft={2}>
                  ...
                  <Divider sx={{ mb: 1 }} />
                  <List>
                    <ListItemButton component={Link} href="/upload" sx={{
                      borderRadius: 2,
                      '&:hover': { bgcolor: (t)=>alpha(t.palette.secondary ? t.palette.secondary.light : t.palette.primary.light,0.08) },
                      opacity: 0, animation: `${fadeUp} .45s ease forwards`, animationDelay: '0ms',
                    }}>
                    ...
                    <ListItemButton component={Link} href="/pay" sx={{
                      borderRadius: 2,
                      '&:hover': { bgcolor: (t)=>alpha(t.palette.secondary ? t.palette.secondary.light : t.palette.primary.light,0.08) },
                      opacity: 0, animation: `${fadeUp} .45s ease forwards`, animationDelay: '180ms',
                    }}>
                ...
                <CardActions sx={{ px: 4, pb: 4 }}>
                  <Button component={Link} href="/upload" variant="contained" startIcon={<UploadFileIcon />}>เริ่มส่งไฟล์</Button>
                  <Button component={Link} href="/pay" color="inherit" startIcon={<QrCodeIcon />}>ไปชำระเงิน</Button>
                </CardActions>
              </Card>
            </Reveal>
          </Box>
