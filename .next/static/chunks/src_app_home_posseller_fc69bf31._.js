...
const CheckOutRight = (param)=>{
    let { cart, total, onCheckout, onDiscountChange, onPaymentChange } = param;
    _s();
...
_s(CheckOutRight, "TcloETjsPIhrAuMfBzH8VfCYis0=");
_c = CheckOutRight;
...
function SuccessModal(param) {
    let { open, total, payment, onClose, onConfirmPaid, onNewOrder } = param;
    _s();
        ...
        "SuccessModal.useEffect": ()=>{
            if (isPaid) {
                const timer = setTimeout({
                    "SuccessModal.useEffect.timer": ()=>{
                        onClose();
                    }
                }["SuccessModal.useEffect.timer"], 5000);
                return ({
...
_s1(SellPage, "BxEZ35lWRCz4QzK6hvvhBJKzKU8=", false, function() {
    return [
        useDebouncedValue
    ];
});
