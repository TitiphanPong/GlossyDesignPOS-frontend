...
"[project]/src/app/home/tasks/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CATALOG = [
    {
        id: 'bc_55x90',
        name: 'นามบัตร 5.5×9 ซม.',
        cover: '💳',
        tint: '#e8f0ff',
        category: 'นามบัตร',
        variants: [
            {
                name: '250g ด้าน – 1 ด้าน',
                price: 300
            },
            {
                name: '250g ด้าน – 2 ด้าน',
                price: 500
            },
            {
                name: '260g เงา – 1 ด้าน',
                price: 300
            },
            {
                name: '260g เงา – 2 ด้าน',
                price: 500
            },
            {
                name: '300g เงา – 1 ด้าน',
                price: 350
            },
            {
                name: '300g เงา – 2 ด้าน',
                price: 550
            },
            {
                name: '180g ด้าน – 1 ด้าน',
                price: 250
            },
            {
                name: '180g ด้าน – 2 ด้าน',
                price: 400
            },
            {
                name: 'PVC ด้าน 200MC – 1 ด้าน',
                price: 500
            },
            {
                name: 'PVC ด้าน 200MC – 2 ด้าน',
                price: 700
            }
        ]
    },
    {
        ...
        variants: [
            {
                name: '250/260เงา/300 ด้าน – 1 หน้า',
                price: 25,
                note: 'ขั้นต่ำ 4 รูป'
            },
            {
                name: '250/260เงา/300 ด้าน – 2 หน้า',
                price: 35,
                note: 'ขั้นต่ำ 4 รูป'
            }
        ]
    },
    {
        ...
        variants: [
            {
                name: 'ทุกชนิดกระดาษ – 1 หน้า',
                price: 35,
                note: 'ขั้นต่ำ 2 รูป'
            },
            {
                name: 'ทุกชนิดกระดาษ – 2 หน้า',
                price: 45,
                note: 'ขั้นต่ำ 2 รูป'
            }
        ]
    },
    {
        ...
        cover: '🖨️',
        tint: '#eef9ff',
        category: 'Print A3/A4',
        variants: [
            {
                name: '250/260เงา – 1 หน้า',
                price: 45
            },
            {
                name: '250/260เงา – 2 หน้า',
                price: 90
            },
            {
                name: '300g ด้าน – 1 หน้า',
                price: 55
            },
            {
                name: '300g ด้าน – 2 หน้า',
                price: 100
            },
            {
                name: '180g – 1 หน้า',
    ...
    {
        id: 'laser_a3plus',
        name: 'Sticker Laser A3+',
        cover: '🧾',
        tint: '#f7f1ff',
        badge: 'NEW',
        category: 'Sticker Laser',
        variants: [
            {
                name: 'PP ขาวเงา – ชุด 7 A3+',
                price: 550
            },
            {
                name: 'PP ขาวด้าน – ชุด 7 A3+',
                price: 550
            },
            {
                name: 'Paper ขาวเงา – ชุด 7 A3+',
                price: 550
            },
            {
                name: 'Paper ขาวด้าน – ชุด 7 A3+',
                price: 550
            },
            {
                name: 'ใส (Clear) – ชุด 7 A3+',
                price: 550
            }
        ]
    }
...
function SellPage() {
    const [tab, setTab] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]('นามบัตร');
    ...
    const filtered = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>CATALOG.filter((p)=>p.category === tab).filter((p)=>p.name.toLowerCase().includes(q.toLowerCase())), [
        tab,
        q
    ]);
    const add = (p, vName)=>{
    ...
    const subQty = (key)=>setCart((prev)=>prev.map((i)=>i.key === key ? {
                    ...i,
                    qty: i.qty - 1
                } : i).filter((i)=>i.qty > 0));
    const addQty = (key)=>setCart((prev)=>prev.map((i)=>i.key === key ? {
                    ...i,
                    qty: i.qty + 1
                } : i));
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Stack$2f$Stack$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Stack$3e$__["Stack"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$ReceiptLongRounded$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                fileName: "[project]/src/app/home/tasks/page.tsx",
                                lineNumber: 194,
                                columnNumber: 11
                            }, this),
                                                ...
                                                secondaryAction: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Stack$2f$Stack$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Stack$3e$__["Stack"], {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$IconButton$2f$IconButton$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__IconButton$3e$__["IconButton"], {
                                                            size: "small",
                                                            onClick: ()=>subQty(i.key),
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$RemoveRounded$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                                                fileName: "[project]/src/app/home/tasks/page.tsx",
                                                                lineNumber: 323,
                                                                columnNumber: 80
                                                            }, void 0)
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$IconButton$2f$IconButton$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__IconButton$3e$__["IconButton"], {
                                                            size: "small",
                                                            onClick: ()=>addQty(i.key),
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$AddRounded$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                                                fileName: "[project]/src/app/home/tasks/page.tsx",
                                                                lineNumber: 325,
                                                                columnNumber: 80
                                                            }, void 0)
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$IconButton$2f$IconButton$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__IconButton$3e$__["IconButton"], {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$icons$2d$material$2f$esm$2f$DeleteRounded$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                                                fileName: "[project]/src/app/home/tasks/page.tsx",
                                                                lineNumber: 326,
                                                                columnNumber: 84
                                                            }, void 0)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e28791b9._.js.map