      ...
      var { m: module, e: exports } = __turbopack_context__;
      {
        ...
        function computeChangedPathImpl(treeA, treeB) {
          ...
          if (!(0, _matchsegments.matchSegment)(segmentA, segmentB)) {
            ...
            return (_extractPathFromFlightRouterState = extractPathFromFlightRouterState(treeB)) !=
              null
...
*/ Object.defineProperty(exports, '__esModule', {
        ...
        function handleHardNavError(error) {
          if (
            ...
            (0, _createhreffromurl.createHrefFromUrl)(new URL(window.location.href)) !==
              (0, _createhreffromurl.createHrefFromUrl)(window.next.__pendingUrl) //TURBOPACK unreachable
          );
          return false;
        }
                ...
                if (pathname && pathname in appIsrManifest) {
                  try {
                    ...
                    if (reason instanceof DOMException) {
                      ...
                      message =
                        (_reason_stack = reason.stack) != null ? _reason_stack : reason.message;
      ...
      var { m: module, e: exports } = __turbopack_context__;
      {
        ...
        function updateCacheNodeOnNavigation(
          ...
          for (let parallelRouteKey in newRouterStateChildren) {
            ...
            const newSegmentKeyChild = (0, _createroutercachekey.createRouterCacheKey)(
              newSegmentChild
            );
          ...
          switch (result.tag) {
            ...
            case _segmentcache.NavigationResultTag.Async: {
              return result.data.then(
                (asyncResult) =>
                  handleNavigationResult(url, state, mutable, pendingPush, asyncResult), // TODO: This matches the current behavior but we need to do something
          ...
          return data.then(
            (param) => {
              ...
              const onlyHashChange =
                !!hash &&
                state.canonicalUrl.split('#', 1)[0] === updatedCanonicalUrl.split('#', 1)[0];
  ...
  '[project]/node_modules/next/dist/client/components/noop-head.js [app-ssr] (ecmascript)': (
    __turbopack_context__
  ) => {
    'use strict';
...
//# sourceMappingURL=node_modules_next_dist_client_071d2431._.js.map
